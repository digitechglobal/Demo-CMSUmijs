...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/media/quangtruong/589E832C9E8301AC/umijs/boilerplate-Umijs/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/media/quangtruong/589E832C9E8301AC/umijs/boilerplate-Umijs/node_modules/warning/warning.js';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/media/quangtruong/589E832C9E8301AC/umijs/boilerplate-Umijs/src/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'vi-VN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/media/quangtruong/589E832C9E8301AC/umijs/boilerplate-Umijs/src/locales/vi-VN.ts')),
    },
    locale: 'vi-VN',
    antd: {
