...
function createField(Field, config) {
  var FieldWithContext = function FieldWithContext(props) {
    ...
    var label = props.label,
        ...
        rest = _objectWithoutProperties(props, ["label", "tip", "tooltip", "placeholder", "width", "proFieldProps", "bordered", "messageVariables"]);
    ...
    (0, _react.useEffect)(function () {
      if (setFieldValueType && props.name) {
        ...
        setFieldValueType(props.name, valueType || rest.valueType || 'text');
      }
    ...
    var otherProps = _objectSpread(_objectSpread(_objectSpread({
      messageVariables: messageVariables
    }, defaultFormItemProps), formItemProps), restFormItemProps);
  ...
  return (
    ...
    _react.default.createElement(_proProvider.ConfigProviderWrap, null, /*#__PURE__*/_react.default.createElement(_FieldContext.default.Provider, {
      value: {
        ...
        setFieldValueType: function setFieldValueType(name, type) {
          if (Array.isArray(name)) {
            fieldsValueType.current = (0, _set.default)(fieldsValueType.current, name, type || 'text');
          } else {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  setLoading(true);
                  _context.next = 4;
                  return rest.onFinish((0, _proUtils.conversionSubmitValue)(values, dateFormatter, fieldsValueType.current));
