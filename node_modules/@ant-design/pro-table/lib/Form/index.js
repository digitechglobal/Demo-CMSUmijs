...
var formInputRender = function formInputRender(props, ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_proForm.ProFormField, _extends({
    ...
    }, restFieldProps) // valueType = textarea，但是在 查询表单这里，应该是个 input 框
    ,
...
var proFormItemRender = function proFormItemRender(_ref2) {
  ...
  var valueType = item.valueType,
      ...
      rest = _objectWithoutProperties(item, ["valueType", "dataIndex", "valueEnum", "renderFormItem", "render", "hideInForm", "hideInSearch", "search", "hideInTable", "renderText", "order", "width", "sorter", "formItemProps", "initialValue", "ellipsis", "index", "filters", "request"]); // 支持 function 的 title
...
var FormSearch = function FormSearch(_ref3) {
  ...
  var columnsListRef = (0, _react.useRef)(domList);
  ...
  (0, _proUtils.useDeepCompareEffect)(function () {
    if (columnsList.length < 1) return; // 如果上次没有生成dom，这次生成了，需要重新计算一次
